        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <ul>
                    ...
                    <li class="p-b-10">
                        <a hsref="#" class="stext-107 cl7 hov-cl1 trans-04">
                       Sản Phẩm Mới 
                        </a>
                    </li>
                </ul>
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <p class="stext-107 cl7 size-201">
                    Any questions? Ngũ Hành Sơn, Đà Nẵng, SDT:038 504 5043
                </p>
            ...
            <div class="row">
                    ...
                    <div class="p-l-25 p-r-30 p-lr-0-lg">
                        <div class="wrap-slick3 flex-sb flex-w">
                            ...
                            <div class="slick3 gallery-lb">
                                <div class="item-slick3" data-thumb="template/images/product-giohang.jpg">
                                    <div class="wrap-pic-w pos-relative">
                                        <img src="template/images/product-giohang.jpg" alt="IMG-PRODUCT">

                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="template/images/product-giohang.jpg">
                                            <i class="fa fa-expand"></i>
                                        </a>
                                    </div>
                                </div>

                                <div class="item-slick3" data-thumb="template/images/product-detail2.jpg">
                                    <div class="wrap-pic-w pos-relative">
                                        <img src="template/images/product-detail2.jpg" alt="IMG-PRODUCT">

                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="template/images/product-detail2.jpg">
                                            <i class="fa fa-expand"></i>
                                        </a>
                                    </div>
                                </div>

                                <div class="item-slick3" data-thumb="template/images/product-detail00.jpg">
                                    <div class="wrap-pic-w pos-relative">
                                        <img src="template/images/product-detail00.jpg" alt="IMG-PRODUCT">

                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="template/images/product-detail00.jpg">
                                            <i class="fa fa-expand"></i>
                                        </a>
                                    </div>
                                </div>
                ...
                <div class="col-md-6 col-lg-5 p-b-30">
                    <div class="p-r-50 p-t-5 p-lr-0-lg">
                        ...
                        Kem dưỡng trắng da tối ưu Hada Labo Perfect White Cream 50g                       
                        </p>
